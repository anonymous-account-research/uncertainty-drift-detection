...
data = arff.loadarff('rialto.arff')
...
model_init = MCDropoutCLFWrapper(model, targets=targets, epochs=100, mcd_runs=50, debug=False)
#adwin_uncertainty.gridsearch_adwin_parameter(stream, model_init, 1, targets, features, starting_value=-48)
...
#kswin_alpha = ks_data.gridsearch_kswin_parameter(stream, model_init, 1, targets, features, starting_value=-28)
kswin_alpha = 1e-58
