...
data = arff.loadarff('gassensor.arff')
...
model_init = MCDropoutCLFWrapper(model, targets=targets, epochs=100, mcd_runs=50, scale_data=True, debug=False)
...
#kswin_alpha = ks_data.gridsearch_kswin_parameter(stream, model_init, 1, targets, features, starting_value=-45)
kswin_alpha = 1e-57
