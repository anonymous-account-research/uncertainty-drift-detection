...
def run_performance_experiment(stream, dataset, model_specification, detection, prediction_type, targets,
    ...
    model = MCDropoutCLFWrapper(model_specification, targets = targets, epochs=100, mcd_runs=50, scale_data=True, debug=False)
...
def get_model(features, targets):
    ...
    x_0 = Dense(128, activation='relu')(inputs)
    x_d0 = Dropout(0.2)(x_0, training=True)
    x_0a = Dense(64, activation='relu')(x_d0)
    x_d0a = Dropout(0.2)(x_0a, training=True)
    x_0b = Dense(32, activation='relu')(x_d0a)
    x_d0b = Dropout(0.2)(x_0b, training=True) #0.1
    x_1 = Dense(16, activation='relu')(x_d0b)
