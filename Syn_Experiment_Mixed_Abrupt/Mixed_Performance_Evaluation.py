...
data = pd.read_csv('../01_Artificial_DataSets/mixed_classification_3_drift_paper.csv')
...
model_init = MCDropoutCLFWrapper(model, targets=targets, epochs=800, debug=False)
adwin_uncertainty.gridsearch_adwin_parameter(stream, model_init, 1, targets, features, starting_value=-3)
...
kswin_alpha = ks_data.gridsearch_kswin_parameter(stream, model_init, 2, targets, features, starting_value=-3)
#kswin_alpha = 1e-58
