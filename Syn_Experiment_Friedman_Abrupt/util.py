...
def run_performance_experiment(stream, dataset, model_specification, detection, prediction_type, targets,
    ...
    model = MCDropoutREGWrapper(model_specification, epochs=1000, mcd_runs=100, debug=False) #epochs = 200, mcd_runs = 100
