...
data = pd.read_csv('kdd99-10-percent_clean.csv')
dataset_name = 'kdd99'
...
# adwin_uncertainty.gridsearch_adwin_parameter(stream, model_init, 1, targets, features, starting_value=-30)
...
#kswin_alpha = ks_data.gridsearch_kswin_parameter(stream, model_init, 1, targets, features, starting_value=-59)
kswin_alpha = 5e-59
