...
data = arff.loadarff('INSECTS-incremental-reoccurring_balanced_norm.arff')
data = pd.DataFrame(data[0])
data['class'] = data['class'].astype('category').cat.codes
dataset_name = 'INSECTS-incremental_reoccurring'
...
model_init = MCDropoutCLFWrapper(model, targets=targets, epochs=50, mcd_runs=25, debug=False, scale_data=True)
