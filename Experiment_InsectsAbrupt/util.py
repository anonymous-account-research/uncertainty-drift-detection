...
def get_model(features, targets):
    ...
    x_z = Dense(128, activation='relu')(inputs)
    x_zd = Dropout(0.1)(x_z, training=True)
    x_a = Dense(64, activation='relu')(x_zd)
    x_d = Dropout(0.1)(x_a, training=True)
    x_0 = Dense(32, activation='relu')(x_d)
